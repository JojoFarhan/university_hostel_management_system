  ...
  <div class="content">
    ...
    <div class="row">
      ...
      if (isset($_POST['search'])) {
        ...
        $sql = "SELECT student_allocation.email, student_allocation.bed_id 
 FROM student_allocation
 INNER JOIN admin_c_room ON student_allocation.bed_id = admin_c_room.bed_id
 WHERE admin_c_room.room_type = '$type';";
